...
class AddUser(unittest.TestCase):
    def test_add_user(self):
        ...
        # Click Add pay
        first_name = driver.find_element(By.ID, 'payGrade_name')
        first_name.clear()
    ...
    def test_add_user_inputan_kosong(self):
        ...
        response_data = driver.find_element(By.XPATH,"/html/body/div[1]/div[3]/div/div[2]/form/fieldset/ol/li[1]/input[1]").text
